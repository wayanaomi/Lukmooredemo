...
import { vendorSupportTickets as initialTickets } from "@/lib/data/vendor-dashboard";
...
function VendorSupportContent() {
  ...
  const form = useForm<TicketInput>({
    ...
    defaultValues: { subject: "", category: "Payments", message: "" },
  });
  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          <h1 className="font-heading text-2xl font-bold">Vendor Support</h1>
          <p className="text-sm text-muted-foreground">Get help from the Lukmoore platform team.</p>
        </div>
